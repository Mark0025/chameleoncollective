...
export default function AdminSettingsPage() {
  ...
  useEffect(() => {
    async function loadConfig() {
      const { data, error } = await getBrandConfig()
      if (data) {
        setConfig(data)
      }
    }
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input 
                    id="slogan" 
                    name="brand.slogan"
                    defaultValue={config.brand?.slogan}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      defaultValue={config.brand?.phone?.primary}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      defaultValue={config.brand?.phone?.secondary}
                ...
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    type="email" 
                    name="brand.email"
                    defaultValue={config.brand?.email}
                ...
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    defaultValue={config.brand?.address?.street}
                    placeholder="Street" 
                    className="mb-2"
                  />
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                    <Input 
                      ...
                      defaultValue={config.brand?.address?.city}
                      placeholder="City" 
                    />
                    <Input 
                      name="brand.address.state"
                      defaultValue={config.brand?.address?.state}
                      placeholder="State" 
                    />
                    <Input 
                      name="brand.address.zip"
                      defaultValue={config.brand?.address?.zip}
                      placeholder="ZIP" 
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <Input 
                        name="brand.hours.weekday"
                        defaultValue={config.brand?.hours?.weekday}
                      />
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="w-24">Saturday:</span>
                      <Input 
                        name="brand.hours.saturday"
                        defaultValue={config.brand?.hours?.saturday}
                      />
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="w-24">Sunday:</span>
                      <Input 
                        name="brand.hours.sunday"
                        defaultValue={config.brand?.hours?.sunday}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div key={color} className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <Input 
                        id={`color-${color}`} 
                        name={`colors.${color}`}
                        defaultValue={config.colors?.[color]}
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {(config.products?.categories || []).map((category: any, index: number) => (
                ...
                {['facebook', 'instagram', 'twitter'].map((platform) => (
                  <div key={platform} className="space-y-2">
                    ...
                    <Input 
                      ...
                      defaultValue={config.social?.[platform]}
